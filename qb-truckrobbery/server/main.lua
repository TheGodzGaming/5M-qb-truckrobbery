...
local cashA = 5250 				--<<how much minimum you can get from a robbery
local cashB = 10450				--<< how much maximum you can get from a robbery
local ActivationCost = 1000		--<< how much is the activation of the mission (clean from the bank)
